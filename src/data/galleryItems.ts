...
const galleryItems: GalleryItem[] = [
    {
        ...
        media: [
            ...
            { type: 'video', source: `${process.env.PUBLIC_URL}/assets/videos/MonsterSmokeTeaser.mp4` },
            ...
            { type: 'image', source: `${process.env.PUBLIC_URL}/assets/images/PinkBlast0.png` },
            { type: 'image', source: `${process.env.PUBLIC_URL}/assets/images/PinkBlast1.png` },
            { type: 'image', source: `${process.env.PUBLIC_URL}/assets/images/PinkBlast2.png` },
    ...
    },
    {
        ...
        media: [
            { type: 'video', source: `${process.env.PUBLIC_URL}/assets/videos/NewToy.mp4` },
            ...
            { type: 'audio', source: `${process.env.PUBLIC_URL}/assets/music/adventure-game-theme.mp3` },
            { type: 'image', source: `${process.env.PUBLIC_URL}/assets/images/PinkBlast2.png` },
        ],
    },
    {
